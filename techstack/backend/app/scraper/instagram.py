...
class InstagramScraper:
    ...
    def _parse_story(self, story: IGStory) -> dict:
        ...
        parsed = {
            ...
            "viewer_count": getattr(story, "viewer_count", 0) if hasattr(story, "viewer_count") else 0,
            "like_count": getattr(story, "like_count", 0) if hasattr(story, "like_count") else 0,
